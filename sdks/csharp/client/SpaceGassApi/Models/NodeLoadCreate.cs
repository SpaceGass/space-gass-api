...
namespace SpaceGassApi.Models
{
    ...
    public partial class NodeLoadCreate : IParsable
    {
...
#nullable restore
        ...
        /// <summary>The node number to apply this load to.</summary>
        public int? Node { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Models.NodeLoadCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::SpaceGassApi.Models.NodeLoadCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::SpaceGassApi.Models.NodeLoadCreate();
        }
        /// <summary>
