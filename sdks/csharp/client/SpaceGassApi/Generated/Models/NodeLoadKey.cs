...
namespace SpaceGassApi.Models
{
    ...
    public partial class NodeLoadKey : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Models.NodeLoadKey"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::SpaceGassApi.Models.NodeLoadKey CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::SpaceGassApi.Models.NodeLoadKey();
        }
        /// <summary>
