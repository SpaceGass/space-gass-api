...
namespace SpaceGassApi.Models
{
    ...
    public partial class NodeReactionQueryResult : IParsable
    {
        /// <summary>The query result rows.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::SpaceGassApi.Models.NodeReaction>? Results { get; set; }
#nullable restore
#else
        public List<global::SpaceGassApi.Models.NodeReaction> Results { get; set; }
#endif
...
#nullable restore
        ...
        public static global::SpaceGassApi.Models.NodeReactionQueryResult CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::SpaceGassApi.Models.NodeReactionQueryResult();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "results", n => { Results = n.GetCollectionOfObjectValues<global::SpaceGassApi.Models.NodeReaction>(global::SpaceGassApi.Models.NodeReaction.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::SpaceGassApi.Models.NodeReaction>("results", Results);
