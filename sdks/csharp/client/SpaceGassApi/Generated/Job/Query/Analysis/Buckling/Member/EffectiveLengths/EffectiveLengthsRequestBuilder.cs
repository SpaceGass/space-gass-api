...
using System;
namespace SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths
{
    /// <summary>
...
#nullable enable
        public async Task<global::SpaceGassApi.Models.BucklingEffectiveLengthQueryResult?> GetAsync(Action<RequestConfiguration<global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder.EffectiveLengthsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::SpaceGassApi.Models.BucklingEffectiveLengthQueryResult> GetAsync(Action<RequestConfiguration<global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder.EffectiveLengthsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder.EffectiveLengthsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder.EffectiveLengthsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets buckling effective length results, optionally filtered by load cases, members and modes.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class EffectiveLengthsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::SpaceGassApi.Job.Query.Analysis.Buckling.Member.EffectiveLengths.EffectiveLengthsRequestBuilder.EffectiveLengthsRequestBuilderGetQueryParameters>
        {
        }
    }
}
