...
using System;
namespace SpaceGassApi.Job.Filters.Items.AxisRange.Metadata
{
    /// <summary>
    /// Builds and executes requests for operations under \job\filters\items\axis-range\metadata
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class MetadataRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Filters.Items.AxisRange.Metadata.MetadataRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MetadataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/filters/items/axis-range/metadata", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Filters.Items.AxisRange.Metadata.MetadataRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MetadataRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/filters/items/axis-range/metadata", rawUrl)
        {
        }
        /// <summary>
        /// Shared schema for the X-Axis, Y-Axis and Z-Axis sub-filters(all three use `FilterAxisRangeDto` on the parent).
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Job.Filters.Items.AxisRange.Metadata.MetadataRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Filters.Items.AxisRange.Metadata.MetadataRequestBuilder WithUrl(string rawUrl)
        {
            return new global::SpaceGassApi.Job.Filters.Items.AxisRange.Metadata.MetadataRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
