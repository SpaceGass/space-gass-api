...
using System;
namespace SpaceGassApi.Job.Filters.Items.Sections.Metadata
{
    /// <summary>
    /// Builds and executes requests for operations under \job\filters\items\sections\metadata
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class MetadataRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Filters.Items.Sections.Metadata.MetadataRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MetadataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/filters/items/sections/metadata", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Filters.Items.Sections.Metadata.MetadataRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MetadataRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/filters/items/sections/metadata", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Job.Filters.Items.Sections.Metadata.MetadataRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Filters.Items.Sections.Metadata.MetadataRequestBuilder WithUrl(string rawUrl)
        {
            return new global::SpaceGassApi.Job.Filters.Items.Sections.Metadata.MetadataRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
