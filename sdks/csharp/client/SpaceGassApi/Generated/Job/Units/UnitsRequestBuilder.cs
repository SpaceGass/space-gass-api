...
using System;
namespace SpaceGassApi.Job.Units
{
    /// <summary>
    ...
    public partial class UnitsRequestBuilder : BaseRequestBuilder
    {
        ...
        public UnitsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/units", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Units.UnitsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnitsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/units", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::SpaceGassApi.Models.Units?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::SpaceGassApi.Models.Units> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Units.UnitsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::SpaceGassApi.Job.Units.UnitsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
