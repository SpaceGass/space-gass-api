...
namespace SpaceGassApi.Job.Loads.LoadCaseGroups.Item.Cases
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Loads.LoadCaseGroups.Item.Cases.CasesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::SpaceGassApi.Models.LoadCase>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::SpaceGassApi.Models.LoadCase>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Job.Loads.LoadCaseGroups.Item.Cases.CasesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Loads.LoadCaseGroups.Item.Cases.CasesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::SpaceGassApi.Job.Loads.LoadCaseGroups.Item.Cases.CasesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class CasesRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
