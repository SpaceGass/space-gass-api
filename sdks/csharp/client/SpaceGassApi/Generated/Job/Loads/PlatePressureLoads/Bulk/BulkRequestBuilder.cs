...
using System;
namespace SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/loads/plate-pressure-loads/bulk{?continueOnError*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/loads/plate-pressure-loads/bulk{?continueOnError*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::SpaceGassApi.Models.PlatePressureLoadBulkResult?> PostAsync(List<global::SpaceGassApi.Models.PlatePressureLoadCreate> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::SpaceGassApi.Models.PlatePressureLoadBulkResult> PostAsync(List<global::SpaceGassApi.Models.PlatePressureLoadCreate> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(List<global::SpaceGassApi.Models.PlatePressureLoadKey> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(List<global::SpaceGassApi.Models.PlatePressureLoadKey> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(List<global::SpaceGassApi.Models.PlatePressureLoadUpdate> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPatchQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(List<global::SpaceGassApi.Models.PlatePressureLoadUpdate> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPatchQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<global::SpaceGassApi.Models.PlatePressureLoadCreate> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<global::SpaceGassApi.Models.PlatePressureLoadCreate> body, Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder WithUrl(string rawUrl)
        {
            return new global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Deletes multiple plate pressure loads. Both case and plate are required for each entry —providing only a case does not delete all pressure loads for that case.The succeeded array echoes back the Ids of each successfully deleted load.
        /// </summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BulkRequestBuilderDeleteRequestConfiguration : RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderDeleteQueryParameters>
        {
        }
        /// <summary>
        /// Updates multiple plate pressure loads. Each item must include case and plate in the body.All load cases referenced must be Primary.
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BulkRequestBuilderPatchRequestConfiguration : RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPatchQueryParameters>
        {
        }
        /// <summary>
        /// Creates multiple loads in a bulk operation.All load cases referenced must exist and be Primary load cases.
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BulkRequestBuilderPostRequestConfiguration : RequestConfiguration<global::SpaceGassApi.Job.Loads.PlatePressureLoads.Bulk.BulkRequestBuilder.BulkRequestBuilderPostQueryParameters>
        {
        }
    }
}
