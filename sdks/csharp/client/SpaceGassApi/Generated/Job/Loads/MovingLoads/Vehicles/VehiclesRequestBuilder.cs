...
using SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Bulk;
...
using System;
namespace SpaceGassApi.Job.Loads.MovingLoads.Vehicles
{
    /// <summary>
    ...
    public partial class VehiclesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Bulk.BulkRequestBuilder Bulk
        {
            get => new global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Bulk.BulkRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The library property</summary>
        public global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Library.LibraryRequestBuilder Library
        {
            get => new global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Library.LibraryRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Item.VehiclesItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Item.VehiclesItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the SpaceGassApi.job.loads.movingLoads.vehicles.item collection</summary>
        /// <param name="position">The item Id</param>
        ...
        public global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.Item.VehiclesItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::SpaceGassApi.Models.MovingLoadVehicle>?> GetAsync(Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder.VehiclesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::SpaceGassApi.Models.MovingLoadVehicle>> GetAsync(Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder.VehiclesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::SpaceGassApi.Models.MovingLoadVehicle>(requestInfo, global::SpaceGassApi.Models.MovingLoadVehicle.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::SpaceGassApi.Models.MovingLoadVehicle?> PostAsync(global::SpaceGassApi.Models.MovingLoadVehicleCreate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::SpaceGassApi.Models.MovingLoadVehicle> PostAsync(global::SpaceGassApi.Models.MovingLoadVehicleCreate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder.VehiclesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder.VehiclesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::SpaceGassApi.Models.MovingLoadVehicleCreate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::SpaceGassApi.Models.MovingLoadVehicleCreate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class VehiclesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::SpaceGassApi.Job.Loads.MovingLoads.Vehicles.VehiclesRequestBuilder.VehiclesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class VehiclesRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
