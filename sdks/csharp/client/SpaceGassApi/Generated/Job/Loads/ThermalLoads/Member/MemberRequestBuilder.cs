...
using SpaceGassApi.Job.Loads.ThermalLoads.Member.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace SpaceGassApi.Job.Loads.ThermalLoads.Member
{
    /// <summary>
    /// Builds and executes requests for operations under \job\loads\thermal-loads\member
    /// </summary>
    ...
    public partial class MemberRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Loads.ThermalLoads.Member.MemberRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MemberRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/loads/thermal-loads/member", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceGassApi.Job.Loads.ThermalLoads.Member.MemberRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MemberRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/job/loads/thermal-loads/member", rawUrl)
        {
        }
    }
}
