...
class VersionRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/service/version", path_parameters)
    ...
    def with_url(self,raw_url: str) -> VersionRequestBuilder:
        """
    ...
    @dataclass
    class VersionRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
