...
class FilterNodes(Parsable):
    ...
    # Node Ids in SG list format (e.g. `"1,5-10,15"`). Empty string means no Id criterion.
    nodes: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FilterNodes:
        """
