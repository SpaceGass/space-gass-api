...
@dataclass
class PlatePressureLoad(Parsable):
    """
    DTO for reading a plate pressure load entity.Represents a distributed pressure load applied to a plate.
    """
    ...
    # The plate number this pressure load is applied to.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PlatePressureLoad:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PlatePressureLoad
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PlatePressureLoad()
