...
if TYPE_CHECKING:
    ...
    from .moving_load_pressure import MovingLoadPressure

@dataclass
class MovingLoadPressureBulkResult(Parsable):
    """
    ...
    succeeded: Optional[list[MovingLoadPressure]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MovingLoadPressureBulkResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MovingLoadPressureBulkResult
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return MovingLoadPressureBulkResult()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "succeeded": lambda n : setattr(self, 'succeeded', n.get_collection_of_object_values(MovingLoadPressure)),
        }
        return fields
