...
if TYPE_CHECKING:
    from .bulk_deleted import BulkDeleted
    from .bulk_error import BulkError

@dataclass
class BulkDeletedBulkResult(Parsable):
    """
    ...
    succeeded: Optional[list[BulkDeleted]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BulkDeletedBulkResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: BulkDeletedBulkResult
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return BulkDeletedBulkResult()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "succeeded": lambda n : setattr(self, 'succeeded', n.get_collection_of_object_values(BulkDeleted)),
        }
        return fields
