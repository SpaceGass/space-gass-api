...
class MovingLoadCombination(Parsable):
    ...
    combine_load_case: Optional[int] = None
    # Factor applied to SpaceGassApi.Models.Dtos.MovingLoads.MovingLoadCombinationDto.CombineLoadCase in the combination.
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "combineLoadCase": lambda n : setattr(self, 'combine_load_case', n.get_int_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("combineLoadCase", self.combine_load_case)
