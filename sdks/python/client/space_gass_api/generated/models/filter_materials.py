...
@dataclass
class FilterMaterials(Parsable):
    """
    ...
    # Material Ids in SG list format. Empty string means no Id criterion.
    materials: Optional[str] = None
    # Whether a sub-filter block includes or excludes matching entities.
    mode: Optional[FilterMode] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FilterMaterials:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: FilterMaterials
        """
