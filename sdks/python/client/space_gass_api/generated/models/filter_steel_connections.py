...
@dataclass
class FilterSteelConnections(Parsable):
    """
    ...
    # Steel-connection Ids in SG list format. Empty string means no Id criterion.
    steel_connections: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FilterSteelConnections:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: FilterSteelConnections
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return FilterSteelConnections()
