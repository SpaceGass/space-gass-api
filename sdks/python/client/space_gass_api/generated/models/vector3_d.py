...
@dataclass
class Vector3D(Parsable):
    """
    A 3D vector with X, Y, Z components.
    """
    # X component (unitless direction).
    x: Optional[float] = None
    # Y component (unitless direction).
    y: Optional[float] = None
    # Z component (unitless direction).
    z: Optional[float] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Vector3D:
        """
