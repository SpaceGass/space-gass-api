...
@dataclass
class PlateStripCreate(Parsable):
    """
    DTO for creating a new plate strip.StartPlate, EndPlate, StartNode, EndNode, and UniformWidth are required; all other fields are optional.
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PlateStripCreate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PlateStripCreate
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PlateStripCreate()
