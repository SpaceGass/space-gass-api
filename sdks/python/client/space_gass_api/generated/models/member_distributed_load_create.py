...
@dataclass
class MemberDistributedLoadCreate(Parsable):
    """
    DTO for creating a new member distributed load.The sub-load number is auto-assigned — do not include it in the request.
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MemberDistributedLoadCreate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MemberDistributedLoadCreate
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return MemberDistributedLoadCreate()
