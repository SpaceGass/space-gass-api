...
@dataclass
class MemberPrestressLoadCreate(Parsable):
    """
    ...
    # The member number to apply this prestress to.
    member: Optional[int] = None
    # Prestress force applied to the member.
    prestress: Optional[float] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MemberPrestressLoadCreate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MemberPrestressLoadCreate
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return MemberPrestressLoadCreate()
