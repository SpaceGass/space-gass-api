...
@dataclass
class PrescribedDisplacement(Parsable):
    """
    DTO for reading a prescribed displacement entity.Represents a prescribed displacement or rotation applied at a node.
    """
    ...
    # The node number this displacement is applied to.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PrescribedDisplacement:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PrescribedDisplacement
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PrescribedDisplacement()
