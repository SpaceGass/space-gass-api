...
if TYPE_CHECKING:
    ...
    from .....models.static_settings import StaticSettings
...
class SettingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/analysis/static/settings", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StaticSettings]:
        ...
        return await self.request_adapter.send_async(request_info, StaticSettings, None)
    ...
    async def patch(self,body: StaticSettingsUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StaticSettings]:
        ...
        return await self.request_adapter.send_async(request_info, StaticSettings, error_mapping)
