...
class InfoRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/analysis/buckling/info
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/analysis/buckling/info{?loadCases*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[InfoRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[AnalysisInfo]:
        """
        Returns a lightweight pre-flight summary describing whether buckling analysisresults are stored for this job and which load cases they cover.
