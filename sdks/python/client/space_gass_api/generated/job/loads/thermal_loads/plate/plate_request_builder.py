...
class PlateRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/loads/thermal-loads/plate
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/thermal-loads/plate", path_parameters)
    
    def by_case_id(self,case_id: int) -> WithCaseItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.thermalLoads.plate.item collection
