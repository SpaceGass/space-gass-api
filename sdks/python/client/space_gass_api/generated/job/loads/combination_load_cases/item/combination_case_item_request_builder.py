...
class CombinationCaseItemRequestBuilder(BaseRequestBuilder):
    ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[CombinationCaseItemRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[LoadCase]:
        """
