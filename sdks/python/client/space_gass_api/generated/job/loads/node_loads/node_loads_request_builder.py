...
if TYPE_CHECKING:
    ...
    from ....models.node_load_create import NodeLoadCreate
...
class NodeLoadsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/loads/node-loads
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new NodeLoadsRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/node-loads{?limit*,loadCases*,loadCategory*,nodes*,offset*}", path_parameters)
    
    def by_case_id(self,case_id: int) -> WithCaseItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.nodeLoads.item collection
    ...
    ) -> Optional[list[NodeLoad]]: ...
    @overload
    async def get(self, request_configuration: Optional[RequestConfiguration[NodeLoadsRequestBuilderGetQueryParameters]] = None) -> Optional[list[NodeLoad]]: ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[NodeLoadsRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[NodeLoad]]:
        """
        ...
        Returns: Optional[list[NodeLoad]]
        """
    ...
    def to_post_request_information(self,body: NodeLoadCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a new load. The load case must exist and be a Primary load case.
        param body: DTO for creating a new node load.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> NodeLoadsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: NodeLoadsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return NodeLoadsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class NodeLoadsRequestBuilderGetQueryParameters():
        """
        Returns all loads with optional filtering and pagination.Use the `loadCases` query parameter to filter by load cases — accepts SG list format(e.g. `"1,3-7,10"`). Omit any list filter to match all.Returns an empty array when no loads match the filter — never 404.Results are sorted by LoadCase ascending, then by entity Id ascending.Pagination metadata is returned in response headers (Total-Count, Offset, Limit).
        """
        ...
        # Node Ids to filter by, in SG list format (e.g. `"1,5-10,12"`).Returns only loads applied to the specified nodes.Omit to return loads for all nodes.
        nodes: Optional[str] = None
    ...
    @dataclass
    class NodeLoadsRequestBuilderGetRequestConfiguration(RequestConfiguration[NodeLoadsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class NodeLoadsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
