...
class MemberConcentratedLoadsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/member-concentrated-loads{?Limit*,LoadCases*,LoadCategory*,Members*,Offset*}", path_parameters)
    
    def by_case_id(self,case_id: int) -> WithCaseItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.memberConcentratedLoads.item collection
    ...
    ) -> Optional[list[MemberConcentratedLoad]]: ...
    @overload
    ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[MemberConcentratedLoadsRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[MemberConcentratedLoad]]:
        """
