...
class WithCaseItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/loads/plate-pressure-loads/{caseId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/plate-pressure-loads/{caseId}", path_parameters)
    
    def by_plate_id(self,plate_id: int) -> WithPlateItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.platePressureLoads.item.item collection
