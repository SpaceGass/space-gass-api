...
class LumpedMassLoadsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/lumped-mass-loads{?limit*,loadCases*,loadCategory*,nodes*,offset*}", path_parameters)
    
    def by_case_id(self,case_id: int) -> WithCaseItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.lumpedMassLoads.item collection
    ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[LumpedMassLoadsRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[LumpedMassLoad]]:
        """
    ...
    class LumpedMassLoadsRequestBuilderGetQueryParameters():
        ...
        # Node Ids to filter by, in SG list format (e.g. `"1,5-10,12"`).Returns only lumped masses applied to the specified nodes.Omit to return lumped masses for all nodes.
        nodes: Optional[str] = None
