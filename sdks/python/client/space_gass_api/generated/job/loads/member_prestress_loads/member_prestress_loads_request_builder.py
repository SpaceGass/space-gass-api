...
class MemberPrestressLoadsRequestBuilder(BaseRequestBuilder):
    ...
    def by_case_id(self,case_id: int) -> WithCaseItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.memberPrestressLoads.item collection
    ...
    ) -> Optional[list[MemberPrestressLoad]]: ...
    @overload
    ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[MemberPrestressLoadsRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[MemberPrestressLoad]]:
        """
    ...
    async def post(self,body: MemberPrestressLoadCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MemberPrestressLoad]:
        """
