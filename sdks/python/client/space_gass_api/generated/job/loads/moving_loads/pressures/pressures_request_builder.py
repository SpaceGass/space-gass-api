...
class PressuresRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new PressuresRequestBuilder and sets the default values.
    ...
    def by_id(self,id: int) -> PressuresItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.loads.movingLoads.pressures.item collection
        ...
        return PressuresItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[PressuresRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[MovingLoadPressure]]:
        ...
        return await self.request_adapter.send_collection_async(request_info, MovingLoadPressure, error_mapping)
    ...
    def with_url(self,raw_url: str) -> PressuresRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PressuresRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return PressuresRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class PressuresRequestBuilderGetRequestConfiguration(RequestConfiguration[PressuresRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class PressuresRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
