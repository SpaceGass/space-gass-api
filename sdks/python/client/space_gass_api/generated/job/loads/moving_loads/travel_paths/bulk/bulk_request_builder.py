...
if TYPE_CHECKING:
    ...
    from ......models.moving_load_travel_path_bulk_result import MovingLoadTravelPathBulkResult
...
class BulkRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/loads/moving-loads/travel-paths/bulk
    """
    ...
    async def patch(self,body: list[MovingLoadTravelPathUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None, **kwargs) -> Optional[MovingLoadTravelPathBulkResult]:
        ...
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MovingLoadTravelPathBulkResult]
        """
        if body is None:
            raise TypeError("body cannot be null.")
    ...
    def to_patch_request_information(self,body: list[MovingLoadTravelPathUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Partially updates multiple catalog items in one call; each body item carries the `id`of the item to update. They persist with a single save.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: list[MovingLoadTravelPathCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates multiple catalog items in one call; they persist with a single save.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
