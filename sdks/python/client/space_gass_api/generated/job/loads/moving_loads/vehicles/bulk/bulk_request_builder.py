...
if TYPE_CHECKING:
    ...
    from ......models.moving_load_vehicle_bulk_result import MovingLoadVehicleBulkResult
...
class BulkRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/loads/moving-loads/vehicles/bulk
    """
    ...
    async def patch(self,body: list[MovingLoadVehicleUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> Optional[MovingLoadVehicleBulkResult]:
        ...
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MovingLoadVehicleBulkResult]
        """
        if body is None:
            raise TypeError("body cannot be null.")
    ...
    def to_patch_request_information(self,body: list[MovingLoadVehicleUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Partially updates multiple catalog items in one call; each body item carries the `id`of the item to update. They persist with a single save.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: list[MovingLoadVehicleCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates multiple catalog items in one call; they persist with a single save.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
