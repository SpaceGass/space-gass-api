...
if TYPE_CHECKING:
    ...
    from ......models.moving_load_scenario_bulk_result import MovingLoadScenarioBulkResult
...
class BulkRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: list[MovingLoadScenarioUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None, **kwargs) -> Optional[MovingLoadScenarioBulkResult]:
        ...
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MovingLoadScenarioBulkResult]
        """
        if body is None:
            raise TypeError("body cannot be null.")
    ...
    def to_patch_request_information(self,body: list[MovingLoadScenarioUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Partially updates multiple catalog items in one call; each body item carries the `id`of the item to update. They persist with a single save.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: list[MovingLoadScenarioCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates multiple catalog items in one call; they persist with a single save.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
