...
if TYPE_CHECKING:
    ...
    from .....models.moving_load_elements import MovingLoadElements
    from .....models.moving_load_elements_update import MovingLoadElementsUpdate
...
class ElementsToLoadRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MovingLoadElements]:
        """
        ...
        Returns: Optional[MovingLoadElements]
        """
        ...
        return await self.request_adapter.send_async(request_info, MovingLoadElements, error_mapping)
    
    async def patch(self,body: MovingLoadElementsUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MovingLoadElements]:
        """
        ...
        param body: Partial update for SpaceGassApi.Models.Dtos.MovingLoads.MovingLoadElementsDto. Omitted properties keep theircurrent value; supply a property (including an empty string to clear) to replace it.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MovingLoadElements]
        """
        if body is None:
    ...
    def to_patch_request_information(self,body: MovingLoadElementsUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Partially updates the selected members/plates (SG list-strings, e.g. `"1,3-7,10"`);omit a field to keep it, or supply an empty string to clear that selection.
        param body: Partial update for SpaceGassApi.Models.Dtos.MovingLoads.MovingLoadElementsDto. Omitted properties keep theircurrent value; supply a property (including an empty string to clear) to replace it.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
