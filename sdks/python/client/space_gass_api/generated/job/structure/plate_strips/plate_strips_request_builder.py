...
class PlateStripsRequestBuilder(BaseRequestBuilder):
    ...
    def by_id(self,id: int) -> PlateStripsItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.structure.plateStrips.item collection
    ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[PlateStripsRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[PlateStrip]]:
        """
