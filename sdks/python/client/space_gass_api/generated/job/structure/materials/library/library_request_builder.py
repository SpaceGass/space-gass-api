...
class LibraryRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/structure/materials/library", path_parameters)
    
    async def post(self,body: MaterialLibraryCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Material]:
        """
    ...
    def to_post_request_information(self,body: MaterialLibraryCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a material by looking it up in a SPACE GASS material library. All materialproperties (Young's modulus, Poisson's ratio, mass density, thermal coefficient,concrete strength) are populated from the library — the caller provides only thematerial name and library.
        param body: DTO for creating a new library-sourced material.All material properties (Young's modulus, Poisson's ratio, etc.) are resolved from thelibrary — the caller provides only the material name and library.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
