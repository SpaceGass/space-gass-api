...
class PlatesRequestBuilder(BaseRequestBuilder):
    ...
    def by_id(self,id: int) -> PlatesItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.structure.plates.item collection
    ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[PlatesRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[Plate]]:
        """
    ...
    async def post(self,body: PlateCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Plate]:
        ...
        param body: DTO for creating a new plate.NodeA, NodeB and NodeC are required; all other fields are optional.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: PlateCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a new item. If a validator is registered, the item is validated before creation.
        param body: DTO for creating a new plate.NodeA, NodeB and NodeC are required; all other fields are optional.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class PlatesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
