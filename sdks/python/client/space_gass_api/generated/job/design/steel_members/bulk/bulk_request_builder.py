...
if TYPE_CHECKING:
    ...
    from .....models.steel_member_bulk_result import SteelMemberBulkResult
...
class BulkRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/design/steel-members/bulk
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/design/steel-members/bulk{?continueOnError*}", path_parameters)
    ...
    async def patch(
        self,
        body: list[SteelMemberUpdate],
        *,
        continue_on_error: Optional[bool] = None,
    ) -> Optional[SteelMemberBulkResult]: ...
    @overload
    async def patch(self, body: list[SteelMemberUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> Optional[SteelMemberBulkResult]: ...
    # --- end overloads ---
    async def patch(self,body: list[SteelMemberUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None, **kwargs) -> Optional[SteelMemberBulkResult]:
        """
        ...
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SteelMemberBulkResult]
        """
        if body is None:
            raise TypeError("body cannot be null.")
        ...
        return await self.request_adapter.send_async(request_info, SteelMemberBulkResult, error_mapping)
    
    # --- @overload added by regen_python_inits.py ---
    @overload
    async def post(
        self,
        body: list[SteelMemberCreate],
        *,
        continue_on_error: Optional[bool] = None,
    ) -> Optional[SteelMemberBulkResult]: ...
    @overload
    async def post(self, body: list[SteelMemberCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> Optional[SteelMemberBulkResult]: ...
    # --- end overloads ---
    async def post(self,body: list[SteelMemberCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None, **kwargs) -> Optional[SteelMemberBulkResult]:
        """
    ...
    def to_patch_request_information(self,body: list[SteelMemberUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Updates multiple items in a bulk operation.Each item must include its Id in the request body.If a validator is registered, all items are validated upfront before any are updated.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: list[SteelMemberCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates multiple items in a bulk operation.If a validator is registered, all items are validated upfront before any are created.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
