...
if TYPE_CHECKING:
    ...
    from ....models.steel_member_create import SteelMemberCreate
    from .bulk.bulk_request_builder import BulkRequestBuilder
    from .item.steel_members_item_request_builder import SteelMembersItemRequestBuilder
    from .metadata.metadata_request_builder import MetadataRequestBuilder
    from .next.next_request_builder import NextRequestBuilder

class SteelMembersRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/design/steel-members
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new SteelMembersRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/design/steel-members{?expand*,limit*,offset*,steelMembers*}", path_parameters)
    
    def by_id(self,id: int) -> SteelMembersItemRequestBuilder:
        """
        Gets an item from the space_gass_api.generated.job.design.steelMembers.item collection
        ...
        return SteelMembersItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    ) -> Optional[list[SteelMember]]: ...
    @overload
    async def get(self, request_configuration: Optional[RequestConfiguration[SteelMembersRequestBuilderGetQueryParameters]] = None) -> Optional[list[SteelMember]]: ...
    # --- end overloads ---
    async def get(self,request_configuration: Optional[RequestConfiguration[SteelMembersRequestBuilderGetQueryParameters]] = None, **kwargs) -> Optional[list[SteelMember]]:
        """
        ...
        Returns: Optional[list[SteelMember]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, SteelMember, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SteelMembersRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Returns all items with optional filtering, pagination and sub-resource expansion.Results are always sorted by Id ascending.Pagination metadata is returned in response headers (Total-Count, Offset, Limit).`Expand` defaults to `none` on list endpoints so payloads stay lean;pass `Expand=all` to hydrate sub-resources. Sub-resource expansion isopt-in per resource type — resources that don't define sub-resources ignore the parameter.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SteelMembersRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SteelMembersRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return SteelMembersRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class SteelMembersRequestBuilderGetQueryParameters():
        """
        Returns all items with optional filtering, pagination and sub-resource expansion.Results are always sorted by Id ascending.Pagination metadata is returned in response headers (Total-Count, Offset, Limit).`Expand` defaults to `none` on list endpoints so payloads stay lean;pass `Expand=all` to hydrate sub-resources. Sub-resource expansion isopt-in per resource type — resources that don't define sub-resources ignore the parameter.
        """
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "steel_members":
                return "steelMembers"
        ...
        # Steel member design group Ids to filter by, in SG list format (e.g. `"1,3-7,10"`).Omit to return all design groups.
        steel_members: Optional[str] = None

    
    @dataclass
    class SteelMembersRequestBuilderGetRequestConfiguration(RequestConfiguration[SteelMembersRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class SteelMembersRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
