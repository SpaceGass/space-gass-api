...
class NodeRestraint(Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> NodeRestraint:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: NodeRestraint
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "rxTable": lambda n : setattr(self, 'rx_table', n.get_object_value(Table)),
            ...
            "ryTable": lambda n : setattr(self, 'ry_table', n.get_object_value(Table)),
            ...
            "rzTable": lambda n : setattr(self, 'rz_table', n.get_object_value(Table)),
            ...
            "txTable": lambda n : setattr(self, 'tx_table', n.get_object_value(Table)),
            ...
            "tyTable": lambda n : setattr(self, 'ty_table', n.get_object_value(Table)),
            ...
            "tzTable": lambda n : setattr(self, 'tz_table', n.get_object_value(Table)),
