...
@dataclass
class SectionCreate(Parsable):
    """
    DTO for creating a new user-defined section.
    """
    # Cross-sectional area. Must be greater than zero.
    a: Optional[float] = None
    # Area modification factor. Defaults to 1.0. Must be greater than zero if provided.
    area_factor: Optional[float] = None
    # Shear area in Y direction. Must be greater than zero.
    ay: Optional[float] = None
    # Shear area in Z direction. Must be greater than zero.
    az: Optional[float] = None
    # Optional GUID (hidden field in SPACEGASS)Some API users find this handy for tracking entities across systems
    guid: Optional[str] = None
    # Second moment of area about Y axis. Must be greater than zero.
    iy: Optional[float] = None
    # Iy modification factor. Defaults to 1.0. Must be greater than zero if provided.
    iy_factor: Optional[float] = None
    # Second moment of area about Z axis. Must be greater than zero.
    iz: Optional[float] = None
    # Iz modification factor. Defaults to 1.0. Must be greater than zero if provided.
    iz_factor: Optional[float] = None
    # Torsion constant. Must be greater than zero.
    ...
    # Torsion modification factor. Defaults to 1.0. Must be greater than zero if provided.
    torsion_factor: Optional[float] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SectionCreate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: SectionCreate
        """
