...
@dataclass
class LumpedMassLoadBatchResult(Parsable):
    """
    ...
    succeeded: Optional[list[LumpedMassLoad]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> LumpedMassLoadBatchResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: LumpedMassLoadBatchResult
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return LumpedMassLoadBatchResult()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "succeeded": lambda n : setattr(self, 'succeeded', n.get_collection_of_object_values(LumpedMassLoad)),
        }
        return fields
