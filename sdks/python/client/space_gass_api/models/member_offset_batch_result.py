...
@dataclass
class MemberOffsetBatchResult(Parsable):
    """
    ...
    succeeded: Optional[list[MemberOffset]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MemberOffsetBatchResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MemberOffsetBatchResult
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return MemberOffsetBatchResult()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "succeeded": lambda n : setattr(self, 'succeeded', n.get_collection_of_object_values(MemberOffset)),
        }
        return fields
