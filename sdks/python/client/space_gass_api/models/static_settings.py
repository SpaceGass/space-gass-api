...
class StaticSettings(Parsable):
    ...
    # Number of damping relaxation steps.Non-linear only.
    damping_steps: Optional[int] = None
    # Whether to include deflections in convergence check.Non-linear only.
    ...
    # Number of load steps.Non-linear only.
    ...
    # Whether to include big P-delta effect.Non-linear only.
    p_delta_big: Optional[bool] = None
    # Whether to include small P-delta effect.Non-linear only.
    ...
    stepping_method: Optional[SteppingMethod] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StaticSettings:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "steppingMethod": lambda n : setattr(self, 'stepping_method', n.get_enum_value(SteppingMethod)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("steppingMethod", self.stepping_method)
