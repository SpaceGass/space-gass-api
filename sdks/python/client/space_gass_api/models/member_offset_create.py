...
class MemberOffsetCreate(Parsable):
    ...
    # The member Id to create the offset for. Required in the request body.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MemberOffsetCreate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MemberOffsetCreate
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return MemberOffsetCreate()
