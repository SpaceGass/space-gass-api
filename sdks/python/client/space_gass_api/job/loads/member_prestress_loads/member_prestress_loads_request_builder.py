...
class MemberPrestressLoadsRequestBuilder(BaseRequestBuilder):
    ...
    class MemberPrestressLoadsRequestBuilderGetQueryParameters():
        ...
        # Member numbers to filter by (e.g., ?members=1&members=5&members=10).Returns only prestress loads applied to the specified members.Omit to return prestress loads for all members.
