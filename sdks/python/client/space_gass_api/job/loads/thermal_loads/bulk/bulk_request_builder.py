...
if TYPE_CHECKING:
    ...
    from .....models.thermal_load_key import ThermalLoadKey
    from .....models.thermal_load_key_batch_result import ThermalLoadKeyBatchResult
    from .....models.thermal_load_update import ThermalLoadUpdate

class BulkRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/loads/thermal-loads/bulk
    """
    ...
    async def delete(self,body: list[ThermalLoadKey], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderDeleteQueryParameters]] = None) -> Optional[ThermalLoadKeyBatchResult]:
        """
        ...
        Returns: Optional[ThermalLoadKeyBatchResult]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, ThermalLoadKeyBatchResult, error_mapping)
    ...
    async def post(self,body: list[ThermalLoadCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> Optional[ThermalLoadBatchResult]:
        """
    ...
    def to_delete_request_information(self,body: list[ThermalLoadKey], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderDeleteQueryParameters]] = None) -> RequestInformation:
        """
        Deletes multiple thermal loads. Case, element, and elementType are all required for each entry.The succeeded array echoes back the keys of each successfully deleted load.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: list[ThermalLoadUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Updates multiple thermal loads. Each item must include case, element, and elementType in the body.All load cases referenced must be Primary.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: list[ThermalLoadCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates multiple loads in a bulk operation.All load cases referenced must exist and be Primary load cases.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
