...
class WithCaseKeyItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/self-weight/{caseKey}", path_parameters)
    ...
    async def patch(self,body: SelfWeightLoadUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SelfWeightLoad]:
        ...
        param body: DTO for updating an existing self-weight load.All fields are nullable to support partial PATCH semantics.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SelfWeightLoad]
        """
        if body is None:
    ...
    async def put(self,body: SelfWeightLoadCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SelfWeightLoad]:
        """
    ...
    def to_put_request_information(self,body: SelfWeightLoadCreate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates the self-weight load for a load case, or replaces it if one already exists.The load case must exist and be a Primary load case.The case is taken from the route — do not include it in the body.
        param body: DTO for creating a new self-weight load.Only one self-weight load is permitted per load case.Use PUT /self-weight/{case} to create or replace.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> WithCaseKeyItemRequestBuilder:
        """
        ...
        return WithCaseKeyItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithCaseKeyItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class WithCaseKeyItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class WithCaseKeyItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class WithCaseKeyItemRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
