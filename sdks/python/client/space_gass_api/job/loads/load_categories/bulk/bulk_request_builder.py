...
if TYPE_CHECKING:
    from .....models.load_category_batch_result import LoadCategoryBatchResult
...
class BulkRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/load-categories/bulk{?continueOnError*,keys*}", path_parameters)
    ...
    async def patch(self,body: list[LoadCategoryUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> Optional[LoadCategoryBatchResult]:
        """
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[LoadCategoryBatchResult]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, LoadCategoryBatchResult, error_mapping)
    
    async def post(self,body: list[LoadCategoryCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> Optional[LoadCategoryBatchResult]:
        """
