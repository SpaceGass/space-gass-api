...
class WithNodeItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/loads/lumped-mass-loads/{caseId}/{nodeId}", path_parameters)
    ...
    async def patch(self,body: LumpedMassLoadUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[LumpedMassLoad]:
        ...
        param body: DTO for updating an existing lumped mass load.Only fields included in the request are updated; omit a field to keep its current value.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[LumpedMassLoad]
        """
        if body is None:
