...
class DisplacementsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new DisplacementsRequestBuilder and sets the default values.
    ...
    def with_url(self,raw_url: str) -> DisplacementsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DisplacementsRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class DisplacementsRequestBuilderGetRequestConfiguration(RequestConfiguration[DisplacementsRequestBuilderGetQueryParameters]):
        """
