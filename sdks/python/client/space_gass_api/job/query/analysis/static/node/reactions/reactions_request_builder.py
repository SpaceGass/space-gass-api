...
class ReactionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/query/analysis/static/node/reactions{?Limit*,Offset*,case*,node*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ReactionsRequestBuilderGetQueryParameters]] = None) -> Optional[NodeReactionQueryResult]:
        """
