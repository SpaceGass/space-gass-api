...
class StressesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new StressesRequestBuilder and sets the default values.
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[StressesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Gets stress results for members, grouped by load case and member.Each result contains stress values at stations along the member.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> StressesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: StressesRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class StressesRequestBuilderGetRequestConfiguration(RequestConfiguration[StressesRequestBuilderGetQueryParameters]):
        """
