...
class RunNonLinearRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/analysis/static/run-non-linear
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new RunNonLinearRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/analysis/static/run-non-linear", path_parameters)
    ...
    async def post(self,body: StaticSettingsUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AnalysisRun]:
        """
        Starts a Non-Linear Static Analysis run. The analysis executes asynchronously in the background.Uses the same settings as Linear Static (shared via GET/PATCH /static/settings).            The request body is optional. If provided, only fields included are applied as settingoverrides before the analysis starts; omitted fields remain unchanged.
    ...
    def with_url(self,raw_url: str) -> RunNonLinearRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RunNonLinearRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return RunNonLinearRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RunNonLinearRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
