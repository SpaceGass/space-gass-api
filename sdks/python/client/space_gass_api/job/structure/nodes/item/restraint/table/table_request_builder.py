...
class TableRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/structure/nodes/{id}/restraint/table
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/structure/nodes/{id}/restraint/table", path_parameters)
    
    def by_direction(self,direction: str) -> WithDirectionItemRequestBuilder:
        """
        Gets an item from the space_gass_api.job.structure.nodes.item.restraint.table.item collection
