...
class WithKeyItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/structure/nodes/{key}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/structure/nodes/{key}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Node]:
        """
        Get by Key
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: NodeUpdate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Node]:
        ...
        param body: DTO for updating an existing node.All coordinate fields are optional to support partial updates.Key is inherited from EntityUpdateBaseDto - nullable because single updatesreceive the key from the route, while batch updates include it in the body.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[Node]
        """
        if body is None:
