...
class BulkRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/structure/members/offsets/bulk
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/structure/members/offsets/bulk{?continueOnError*}", path_parameters)
    ...
    async def delete(self,body: list[int], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderDeleteQueryParameters]] = None) -> Optional[ObjectBatchResult]:
        """
        Deletes offset rows for multiple members in a single request.Each item in the array is a member number.Members without an offset row are reported as errors.
    ...
    async def patch(self,body: list[MemberOffsetUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> Optional[MemberOffsetBatchResult]:
        """
        Partially updates offsets for multiple members in a single request.Each item must include member to identify which offsets row to update.Only provided fields are changed; omitted fields remain unchanged.The offsets row must already exist (use POST /offsets/bulk to create).Use continueOnError=true to process all items even if some fail.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def post(self,body: list[MemberOffsetCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> Optional[MemberOffsetBatchResult]:
        """
        Creates or replaces offsets for multiple members in a single request.Each item must include a member number. If offsets already exist for a member, they are replaced.Use continueOnError=true to process all items even if some fail.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MemberOffsetBatchResult]
        """
    ...
    def to_post_request_information(self,body: list[MemberOffsetCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates or replaces offsets for multiple members in a single request.Each item must include a member number. If offsets already exist for a member, they are replaced.Use continueOnError=true to process all items even if some fail.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
