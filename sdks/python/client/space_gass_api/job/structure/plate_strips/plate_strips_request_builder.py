...
class PlateStripsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/structure/plate-strips{?Limit*,Offset*,Strips*}", path_parameters)
    ...
    class PlateStripsRequestBuilderGetQueryParameters():
        ...
        # Comma-separated list of specific strip numbers to return (e.g., "1,5,10").
