...
if TYPE_CHECKING:
    ...
    from .....models.plate_strip_batch_result import PlateStripBatchResult
...
class BulkRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /job/structure/plate-strips/bulk
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/job/structure/plate-strips/bulk{?continueOnError*,keys*}", path_parameters)
    ...
    async def patch(self,body: list[PlateStripUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> Optional[PlateStripBatchResult]:
        """
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PlateStripBatchResult]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, PlateStripBatchResult, error_mapping)
    
    async def post(self,body: list[PlateStripCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> Optional[PlateStripBatchResult]:
        """
    ...
    def to_patch_request_information(self,body: list[PlateStripUpdate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Updates multiple items in a bulk operation.Each item must include its Key in the request body.If a validator is registered, all items are validated upfront before any are updated.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: list[PlateStripCreate], request_configuration: Optional[RequestConfiguration[BulkRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Creates multiple items in a bulk operation.If a validator is registered, all items are validated upfront before any are created.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
