...
```python title="Python"
PORT = 35000
client = create_client(f"http://localhost:{PORT}/api/v1")
...
The complete examples with error handling and Ctrl+C wiring are
available in the repository:

- [C# — Example.ServiceAutomation](https://github.com/Spacegass/space-gass-api/tree/develop/sdks/csharp/examples/Example.ServiceAutomation)
- [Python — service_automation](https://github.com/Spacegass/space-gass-api/tree/develop/sdks/python/examples/service_automation)
