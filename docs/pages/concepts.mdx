...
[Examples](/examples/simple-beam) cover that. Read this once
...
the [Simple Beam tutorial](/examples/simple-beam) both follow
this pattern.
...
- [Simple Beam Model](/examples/simple-beam) — the full
