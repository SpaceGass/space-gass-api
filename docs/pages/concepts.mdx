...
[Quick Start](/quick-start) and the
[Examples](/examples/tutorials/simple-beam) cover that. Read this once
...
the middle throws. The [Quick Start](/quick-start) and
the [Simple Beam tutorial](/examples/tutorials/simple-beam) both follow
this pattern.
...
- [Quick Start](/quick-start) — open the `Portal Frame.SG`
  sample and read its nodes in five minutes.
- [Using the SDK](/using-the-sdk) — REST verbs and
  async patterns translated for engineers.
- [Simple Beam Model](/examples/tutorials/simple-beam) — the full
