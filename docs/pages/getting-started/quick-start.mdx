...
The C# and Python versions are also runnable as
[Example.QuickStart](https://github.com/Spacegass/space-gass-api/tree/develop/sdks/csharp/examples/Example.QuickStart)
(C#) and
[quick_start](https://github.com/Spacegass/space-gass-api/tree/develop/sdks/python/examples/quick_start)
(Python) in the repo — clone and run, no copy-paste needed.
