---
title: Overview
description: "Start here — programmatic access to SPACE GASS. Machine-readable OpenAPI spec: https://api.spacegass.com/docs/api/1/schema.json"
---
...
- [Quick Start](/quick-start) — Get up and running
  in 5 minutes
- [Simple Beam Model](/examples/tutorials/simple-beam) — Full walkthrough
